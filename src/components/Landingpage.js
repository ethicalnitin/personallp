      ...
      <div className="pt-24 flex flex-col justify-center items-center"> {/* pt-24 to push content below the fixed navbar */}
        ...
        <div className="text-left max-w-md mb-4">
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>Quick and hassle-free activation</strong>: Get your plan activated within 20 minutes of purchase.</li>
          </ul>
        </div>
        ...
        <div className="text-black text-left max-w-md space-y-6 mb-16"> {/* Added mb-16 to prevent overlap */}
          ...
          {/* How to Access Section - No Numbering */}
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            <div className="space-y-2 text-left">
              ...
              <p>You will receive an <strong>activation email within 20 minutes</strong> with your TradingView Premium plan access.</p>
